export const data = {
    ...
    text: `I am a software engineer, UX designer, photographer, and blogger. I studied Software Engineering at UC Irvine and graduated in 2020. I have been working in Silicon Valley as a full-stack web developer since then with a focus on the design and implementation of user interfaces using JavaScript-based frameworks and libraries. I am a hobbyist photographer and blogger interested in art, philosophy, and social sciences.`,
  };

  export const social = [
    {
      name: "Facebook",
      url: "https://www.facebook.com/payam.dowlatyari",
      icon: "M42,3H8C5.2,3,3,5.2,3,8v34c0,2.8,2.2,5,5,5h34c2.8,0,5-2.2,5-5V8C47,5.2,44.8,3,42,3z M37,19h-2c-2.1,0-3,0.5-3,2v3h5 l-1,5h-4v16h-5V29h-4v-5h4v-3c0-4,2-7,6-7c2.9,0,4,1,4,1V19z",
    },
    {
      name: "Github",
